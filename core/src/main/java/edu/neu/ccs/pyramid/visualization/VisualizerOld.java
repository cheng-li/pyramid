 ...
 * @version 1.0.0
 */
public class VisualizerOld {
    
    private final VisualizerConfig config;

    public VisualizerOld(VisualizerConfig config) {
        this.config = config;
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        VisualizerOld visualizerOld = new VisualizerOld(new VisualizerConfig(new Config(args[0])));
        visualizerOld.visualize();
    }
