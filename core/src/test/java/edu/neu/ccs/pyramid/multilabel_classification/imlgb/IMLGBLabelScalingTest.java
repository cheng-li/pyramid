...
public class IMLGBLabelScalingTest {
    public static void main(String[] args) throws Exception{
        ...
        IMLGBIsotonicScaling imlgbIsotonicScaling = (IMLGBIsotonicScaling) Serialization.deserialize(config.getString("isotonicScaling"));
        IMLGBLabelScaling imlgbLabelScaling = new IMLGBLabelScaling(imlgbIsotonicScaling);
        IMLGBLabelScaling.BucketInfo total = imlgbLabelScaling.individualAccuracy(multiLabelClfDataSet);
        ...
        outputdir.mkdirs();
        File accsFile = new File(outputdir,"labelCalibrationResult.txt");
