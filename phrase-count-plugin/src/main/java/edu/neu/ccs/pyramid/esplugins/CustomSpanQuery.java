...
public abstract class CustomSpanQuery extends Query {
  ...
  @Override
  public abstract CustomSpanWeight createWeight(IndexSearcher searcher, boolean needsScores) throws IOException;
