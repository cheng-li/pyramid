 ...
 */
public abstract class CustomSpanWeight extends Weight {
  ...
  protected boolean weightedCount = false;

  /**
   * Create a new CustomSpanWeight
   ...
   */
  public CustomSpanWeight(CustomSpanQuery query, IndexSearcher searcher, Map<Term, TermContext> termContexts) throws IOException {
    super(query);
  ...
  public boolean isWeightedCount() {
      return weightedCount;
  }

  public void setWeightedCount(boolean weightedCount) {
      this.weightedCount = weightedCount;
  }
  ...
  public Explanation explain(LeafReaderContext context, int doc) throws IOException {
      PhraseCountScorer scorer = scorer(context);
      if (scorer != null) {
