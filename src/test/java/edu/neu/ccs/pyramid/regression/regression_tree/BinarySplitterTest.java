...
//        test3();
    ...
    static void test3(){
        ...
        System.out.println(BinarySplitter.split(regTreeConfig, dataSet, labels, probs, 0));
        System.out.println(BinarySplitter.split(regTreeConfig, dataSet, labels, probs, 0).isPresent());
