...
//        test4Dump();
    ...
    private static void test4Dump(){
        MultiLabelClfDataSet all = MultiLabelSynthesizer.flipOne(1000,2,2);
        List<Integer> trainIndices = IntStream.range(0,500).mapToObj(i -> i).collect(Collectors.toList());
        List<Integer> testIndices = IntStream.range(500,1000).mapToObj(i->i).collect(Collectors.toList());
