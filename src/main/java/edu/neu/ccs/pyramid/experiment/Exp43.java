...
import edu.neu.ccs.pyramid.data_formatter.question_classification.IndexBuilder;
        ...
        for (File file: files){
            try(BufferedReader br = new BufferedReader(new FileReader(file))
                ...
                while((line=br.readLine())!=null){
                    ...
                    IndexResponse response = client.prepareIndex("question_classification", "document",""+id)
                            .setSource(builder)
                            .execute()
                            .actionGet();
                    id += 1;
