...
/**
 * generate exp211 configs for tmc
...
public class Exp148 {
    ...
    private static String generate(int numCluster, int configIndex){
        ...
        sb.append("input.trainData=/scratch/wang.bin/trec.data/tmc2007/data_sets/train").append("\n");
        sb.append("input.testData=/scratch/wang.bin/trec.data/tmc2007/data_sets/test").append("\n");
        sb.append("input.matrixType=sparse_random").append("\n");
        sb.append("output=/scratch/li.che/projects/pyramid/archives/exp211/tmc/").append(configIndex).append("\n");
    ...
    private static String job(int configIndex){
        ...
        sb.append("#BSUB -oo /scratch/li.che/pyramid/exp211/logs/tmc/").append(configIndex).append(".log").append("\n");
        sb.append("./run.sh configs/tmc/").append(configIndex).append(" >> logs/tmc/").append(configIndex).append("\n");
        return sb.toString();
    }
}
