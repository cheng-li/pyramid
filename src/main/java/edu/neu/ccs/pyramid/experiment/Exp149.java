...
/**
 * generate exp211 configs for mediamill
...
public class Exp149 {
    public static void main(String[] args) throws Exception{
        ...
        int configStart = 31;
        String out = "/Users/chengli/tmp/mediamill";
    ...
    private static String generate(int numCluster, int configIndex){
        ...
        sb.append("input.trainData=/scratch/wang.bin/trec.data/mediamill/data_sets/train").append("\n");
        sb.append("input.testData=/scratch/wang.bin/trec.data/mediamill/data_sets/test").append("\n");
        sb.append("input.matrixType=dense").append("\n");
        sb.append("output=/scratch/li.che/projects/pyramid/archives/exp211/mediamill/").append(configIndex).append("\n");
        ...
        sb.append("lr.multiClassVariance=1000").append("\n");
        sb.append("lr.binaryVariance=1000").append("\n");
    ...
    private static String job(int configIndex){
        ...
        sb.append("#BSUB -oo /scratch/li.che/pyramid/exp211/logs/mediamill/").append(configIndex).append(".log").append("\n");
        sb.append("./run.sh configs/mediamill/").append(configIndex).append(" >> logs/mediamill/").append(configIndex).append("\n");
        return sb.toString();
    }
}
