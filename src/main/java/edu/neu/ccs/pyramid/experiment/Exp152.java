...
/**
 * generate exp211 configs for rcv1_1
...
public class Exp152 {
    ...
    private static String generate(int numCluster, int configIndex){
        ...
        sb.append("input.trainData=/scratch/wang.bin/trec.data/rcv1subset_topics_1/data_sets/train").append("\n");
        sb.append("input.testData=/scratch/wang.bin/trec.data/rcv1subset_topics_1/data_sets/test").append("\n");
        sb.append("input.matrixType=sparse_random").append("\n");
        sb.append("output=/scratch/li.che/projects/pyramid/archives/exp211/rcv1_1/").append(configIndex).append("\n");
        ...
        sb.append("lr.multiClassVariance=1000000").append("\n");
        sb.append("lr.binaryVariance=1000000").append("\n");
