...
//        }
    ...
    static void trainModel(Config config, ClfDataSet dataSet, FeatureMappers featureMappers,
        ...
        LogisticLoss logisticLoss = new LogisticLoss(logisticRegression,dataSet,config.getDouble("train.gaussianPriorVariance"));
        GradientDescent gradientDescent = new GradientDescent(logisticLoss,config.getDouble("train.learningRate"));
