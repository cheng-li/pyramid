...
import edu.neu.ccs.pyramid.data_formatter.imdb_movie_genre.IndexBuilder;
...
public class Exp52 {
    public static void main(String[] args) throws Exception{
        ...
        for (File file: files){
            ...
            IndexResponse response = client.prepareIndex("imdb_movie_genre", "document",""+id)
                    .setSource(builder)
                    .execute()
                    .actionGet();
            id += 1;
