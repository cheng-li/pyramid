...
/**
 * overlap and hamming loss
 * Created by chengli on 2/5/16.
 */
public class Exp157 {
...
//            sb.append(algorithms[i]).append(" ");
        ...
        sb.append("\\hline").append("\n");
        FileUtils.writeStringToFile(new File("/Users/chengli/Documents/papers/LTR/ICML16_mixture/supplementary/tables//performance.txt"), sb.toString(), false);
