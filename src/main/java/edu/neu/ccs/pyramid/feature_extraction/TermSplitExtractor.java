 ...
 */
public class TermSplitExtractor {
    ...
    public TermSplitExtractor(ESIndex index, IdTranslator idTranslator,
                              int topN) {
        this.index = index;
        this.topN = topN;
    ...
    public TermSplitExtractor setMinDataPerLeaf(int minDataPerLeaf) {
